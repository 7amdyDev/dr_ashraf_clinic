...
import 'package:dr_ashraf_clinic/view/clinic/doctor/screen/settings/widget/Examination_search_table.dart';
...
class ExaminationSettingsWidget extends StatelessWidget {
  ExaminationSettingsWidget({super.key});
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      HFilledButton(
                        ...
                        onPressed: () {
                          clinicController
                              .searchExaminationDatabase(searchText.text);
                          searchText.clear();
                        },
                      )
                    ],
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      HFilledButton(
                        ...
                        text: 'add_label',
                        onPressed: () {
                          clinicController.addExaminationToDB(addText.text);
                          addText.clear();
                        },
                      )
                    ],
