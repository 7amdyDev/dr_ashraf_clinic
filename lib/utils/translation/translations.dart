...
class AppTranslation extends Translations {
  ...
  Member of Harvard University - USA
      ...
      'hint_search_label': 'Search by File no., Telephone no., Patient name.',
      ...
      'Select a clinic branch and a date to reserve.':
          'Select a clinic branch and a date to reserve.',
      'No Date Selected': 'No Date Selected',
      'newest_videos_label': 'Newest Videos',
      'schedule_label': 'Clinic Schedule',
    },
    'ar_EG': {
    ...
    عضو الجمعية المصرية للسكر
      ...
      'blog_button': 'المدونة',
      'videos_button': 'الفيديوهات',
      'Select a clinic branch and a date to reserve.':
          'اختر فرع العيادة وتاريخ الحجز.',
      'No Date Selected': 'لم يتم اختيار تاريخ',
      'Please select a date to reserve.': 'الرجاء اختيار تاريخ الحجز.',
      'Reserved': 'مكتمل',
      'schedule_label': 'مواعيد العيادة',
      'newest_videos_label': 'أحدث الفيديوهات',
    },
  };
}
